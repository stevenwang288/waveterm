                    ...
                    if (fullConfig.settings["window:confirmclose"]) {
                        ...
                        if (isNonEmptyUnsavedWorkspace(workspace)) {
                            const choice = dialog.showMessageBoxSync(this, {
                                type: "question",
                                buttons: [i18next.t("common.cancel"), i18next.t("common.closeWindow")],
                                title: i18next.t("common.confirm"),
                                message: i18next.t("workspace.confirmCloseWindowUnsavedTabs"),
                            });
                            if (choice === 0) {
                                return;
                            }
...
ipcMain.on("delete-workspace", (event, workspaceId) => {
    fireAndForget(async () => {
        ...
        const choice = dialog.showMessageBoxSync(this, {
            type: "question",
            buttons: [i18next.t("common.cancel"), i18next.t("common.deleteWorkspace")],
            title: i18next.t("common.confirm"),
            message: i18next.t("workspace.confirmDeleteWorkspace"),
        });
        if (choice === 0) {
