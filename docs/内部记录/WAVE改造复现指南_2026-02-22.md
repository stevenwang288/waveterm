...
- 分支：`master`
- 目标提交（commit）：`36d6ce154741fb4cd57b7e7b1bf01113a5472f78`
- 版本号：`0.14.0-6`
- Windows 安装包（本机交付落点）：`D:\DESK\WAVE-win32-x64-0.14.0-6.exe`
...
2. 切到目标分支：
   - `git switch master`
   - `git checkout 36d6ce154741fb4cd57b7e7b1bf01113a5472f78`
3. 安装依赖并打包：
   - `npm install`
   - `task package`
4. 产物：
   - `make\0.14.0-6\WAVE-win32-x64-0.14.0-6.exe`
5. 放到桌面（你机器约定）：
   - 复制到 `D:\DESK\WAVE-win32-x64-0.14.0-6.exe`
...
3. 切到目标分支代码：
   ...
   - `git checkout 36d6ce154741fb4cd57b7e7b1bf01113a5472f78`
4. 验证版本号：
   - 检查 `package.json` 的 `version` 为 `0.14.0-6`
