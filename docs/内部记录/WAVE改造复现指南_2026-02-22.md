...
- 分支：`master`
- 目标提交（commit）：`c6e05f7ec9bbaee6db85611b8d44dae8eb3f98e8`
- 版本号：`0.14.0-4`
- Windows 安装包（本机交付落点）：`D:\desk\WAVE-win32-x64-0.14.0-4.exe`
...
2. 切到目标分支：
   - `git switch master`
   - `git checkout c6e05f7ec9bbaee6db85611b8d44dae8eb3f98e8`
3. 安装依赖并打包：
   - `npm install`
   - `task package`
4. 产物：
   - `make\0.14.0-4\WAVE-win32-x64-0.14.0-4.exe`
5. 放到桌面（你机器约定）：
   - 复制到 `D:\desk\WAVE-win32-x64-0.14.0-4.exe`
...
3. 切到目标分支代码：
   ...
   - `git checkout c6e05f7ec9bbaee6db85611b8d44dae8eb3f98e8`
4. 验证版本号：
   - 检查 `package.json` 的 `version` 为 `0.14.0-4`
