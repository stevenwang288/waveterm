...
交付安装包：`D:\DESK\WAVE-win32-x64-0.14.0-6.exe`
...
- Windows 安装包版本采用 `0.14.0-<patch>` 递增：
  - `0.14.0-1` → `0.14.0-2` → `0.14.0-3` → `0.14.0-4` → `0.14.0-5` → `0.14.0-6`
- 目的：
  - 每次交付一个“你能安装验证”的明确版本；
...
**交付版本**
- 最新：`0.14.0-6`（`D:\DESK\WAVE-win32-x64-0.14.0-6.exe`）
...
- 推送到在线仓库：`origin/master`（commit `36d6ce154741fb4cd57b7e7b1bf01113a5472f78`）
- 交付安装包：`D:\DESK\WAVE-win32-x64-0.14.0-6.exe`
...
- 状态：
  - 推送远端：已完成（`origin/master` 已更新到 `0.14.0-6`，并已产出安装包到 `D:\DESK`）。
