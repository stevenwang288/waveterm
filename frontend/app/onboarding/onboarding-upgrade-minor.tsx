            ...
            <div className="flex flex-col h-full">
                <header className="flex flex-col gap-2 border-b-0 p-0 mt-1 mb-4 w-full unselectable flex-shrink-0">
                    ...
                    <div className="text-center text-[25px] font-normal text-foreground">
                        {t("onboarding.upgradeMinor.welcomeTitle", { version: "0.13" })}
                    </div>
                </header>
                    ...
                    <div className="flex flex-col items-center gap-3 w-full mb-2 unselectable">
                        <div className="flex flex-col items-center gap-4 text-center">
                            <div className="flex h-[52px] px-3 items-center rounded-lg bg-hover text-accent text-[24px]">
                                ...
                                <span className="font-bold ml-2 font-mono">{t("onboarding.waveAiTitle")}</span>
                            </div>
                            <div className="text-secondary leading-relaxed max-w-[600px]">
                                <p className="mb-4">{t("onboarding.upgradeMinor.waveAiIntro")}</p>
                                <p className="mb-4">
                                    <Trans
                                        i18nKey="onboarding.upgradeMinor.newInVersion"
                                        values={{ version: "0.13" }}
                                ...
                                <p className="py-3 px-2 border border-border rounded-md bg-hover/30">
                                    <Trans
                                        i18nKey="onboarding.upgradeMinor.betaFeedback"
                                        components={[
                                            <a
                                                target="_blank"
                        ...
                        <div className="flex flex-col items-center gap-3 text-center max-w-[550px]">
                            ...
                            <div className="text-secondary text-sm">
                                {t("onboarding.upgradeMinor.githubStarDesc")}
                            </div>
                        </div>
                    </div>
                </OverlayScrollbarsComponent>
