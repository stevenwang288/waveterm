        ...
        <div className="waveblock">
            <div className="wave-block-content">
                ...
                <div className="wave-block-info">
                    ...
                    <span className="wave-block-size">
                        {sizeInKB} {i18next.t("units.kb")}
                    </span>
                </div>
            </div>
        </div>
...
const MarkdownImg = ({
    ...
    return <span>{i18next.t("markdown.imagePlaceholder")}</span>;
};
        ...
        if (showToc) {
            if (tocRef.current.length > 0) {
                ...
                return (
                    ...
                    >
                        {i18next.t("preview.noSubHeadingsFound")}
                    </div>
                );
            }
        }
            ...
            {toc && (
                <OverlayScrollbarsComponent className="toc mt-1" options={{ scrollbars: { autoHide: "leave" } }}>
                    <div className="toc-inner">
                        <h4 className="font-bold">{i18next.t("preview.tableOfContents")}</h4>
                        {toc}
                    </div>
                </OverlayScrollbarsComponent>
            )}
