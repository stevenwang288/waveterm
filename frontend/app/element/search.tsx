...
const SearchComponent = ({
    ...
    const regexDecl = createToggleButtonDecl(regexAtom, "custom@regex", t("search.regex"));
    const wholeWordDecl = createToggleButtonDecl(wholeWordAtom, "custom@whole-word", t("search.wholeWord"));
    const caseSensitiveDecl = createToggleButtonDecl(caseSensitiveAtom, "custom@case-sensitive", t("search.caseSensitive"));
