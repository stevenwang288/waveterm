...
export function blockViewToName(view: string): string {
    if (util.isBlank(view)) {
        return i18next.t("block.viewName.none");
    }
    if (view == "term") {
        return i18next.t("block.viewName.terminal");
    }
    if (view == "preview") {
        return i18next.t("block.viewName.preview");
    }
    if (view == "web") {
    ...
    if (view == "tips") {
        return i18next.t("block.viewName.tips");
    }
    return view;
}
