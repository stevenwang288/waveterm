...
const configFiles: ConfigFile[] = [
    {
        name: i18next.t("waveconfig.files.general"),
        path: "settings.json",
        language: "json",
    ...
    {
        name: i18next.t("waveconfig.files.connections"),
        path: "connections.json",
        language: "json",
        docsUrl: "https://docs.waveterm.dev/connections",
        description: isWindows()
            ? i18next.t("waveconfig.files.connectionsDescWindows")
            : i18next.t("waveconfig.files.connectionsDesc"),
        hasJsonView: true,
    },
    {
        name: i18next.t("waveconfig.files.sidebarWidgets"),
        path: "widgets.json",
        language: "json",
    ...
    {
        name: i18next.t("waveconfig.files.waveAiModes"),
        path: "waveai.json",
        language: "json",
        description: i18next.t("waveconfig.files.waveAiModesDesc"),
    ...
    {
        name: i18next.t("waveconfig.files.tabBackgrounds"),
    ...
    {
        name: i18next.t("waveconfig.files.secrets"),
        path: "secrets",
        isSecrets: true,
        hasJsonView: false,
...
const deprecatedConfigFiles: ConfigFile[] = [
    {
        name: i18next.t("waveconfig.files.presets"),
        path: "presets.json",
        language: "json",
        deprecated: true,
        hasJsonView: true,
    ...
    {
        name: i18next.t("waveconfig.files.aiPresets"),
...
export class WaveConfigViewModel implements ViewModel {
    ...
    viewType = "waveconfig";
    viewIcon = atom("gear");
    viewName = atom(i18next.t("waveconfig.title"));
