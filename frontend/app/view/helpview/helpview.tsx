...
class HelpViewModel extends WebViewModel {
    ...
    constructor(blockId: string, nodeModel: BlockNodeModel, tabModel: TabModel) {
        ...
        this.viewName = atom(i18next.t("block.viewName.help"));
    }
    ...
    getSettingsMenuItems(): ContextMenuItem[] {
        ...
        return [
            {
                label: this.webviewRef.current?.isDevToolsOpened() ? i18next.t("webview.closeDevTools") : i18next.t("webview.openDevTools"),
                click: async () => {
