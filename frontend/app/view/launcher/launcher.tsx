...
import i18next from "@/app/i18n"; // Import instance for class usage
...
export class LauncherViewModel implements ViewModel {
    ...
    viewName = atom(i18next.t("launcher.viewName")); // Use global instance
        ...
        <div ref={containerRef} className="w-full h-full p-4 box-border flex flex-col items-center justify-center">
            ...
            <div className="mt-4 text-secondary text-xs">
                {filteredWidgets.length === 0 ? (
                    ...
                    <span>
                        {searchTerm == "" ? t("launcher.typeToFilter") : t("launcher.searching", { term: searchTerm })}, {t("launcher.enterToLaunch")}
                        {searchTerm == "" ? t("launcher.arrowKeys") : null}
                    </span>
                )}
            </div>
        </div>
