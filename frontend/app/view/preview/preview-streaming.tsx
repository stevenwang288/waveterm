...
function ImageZoomControls() {
    ...
    return (
        <div className="absolute flex flex-row z-[2] top-0 right-0 p-[5px] gap-1">
            <Button onClick={() => zoomIn()} title={i18next.t("menu.zoomIn")} className="py-1 px-[5px]">
                <i className="fa-sharp fa-plus" />
            </Button>
            <Button onClick={() => zoomOut()} title={i18next.t("menu.zoomOut")} className="py-1 px-[5px]">
                <i className="fa-sharp fa-minus" />
            </Button>
            <Button onClick={() => resetTransform()} title={i18next.t("menu.resetZoom")} className="py-1 px-[5px]">
...
function StreamingPreview({ model }: SpecializedViewProps) {
    ...
    return <CenteredDiv>{i18next.t("preview.notSupported")}</CenteredDiv>;
}
