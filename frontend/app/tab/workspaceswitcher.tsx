    ...
    return (
        ...
        >
            ...
            <PopoverContent className="workspace-switcher-content">
                <div className="title">{isActiveWorkspaceSaved ? t("workspace.switchWorkspace") : t("workspace.openWorkspace")}</div>
...
const WorkspaceSwitcherItem = ({
    ...
    const windowIconDecl: IconButtonDecl = {
        ...
        title: isCurrentWorkspace ? t("workspace.current") : t("workspace.isOpen"),
    };
